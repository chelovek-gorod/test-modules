...
const textCursor = new Text(cursorActionsText, Math.floor(screen.width / 2), Math.floor(screen.height / 2), textCursorOptions);
const cursorState = { x: 0, y: 0, isClick: false };
...
const textKey = new Text(keyActionsText, Math.floor(screen.width / 2), Math.floor(screen.height / 2) - 12, textKeyOptions);
